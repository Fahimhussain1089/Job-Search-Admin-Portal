...
class _SignUpState extends State<SignUp>with TickerProviderStateMixin {
  ...
  final TextEditingController _locationtController = TextEditingController(text: '');
 ...
 // FocusNode _compnayAddressFocusNode = FocusNode();
  ...
  void _showImageDialog(){
    showDialog(
        context: context, builder: (context){
          return  AlertDialog(
            title: Text('Plese chose an option'),
            content: Column(
                ...
                InkWell(
                  ...
                  child: const  Row(
                    children: [
                      ...
                      child: Icon(
                        Icons.camera,color: Colors.purple,
                        ),
                      ),
                      Text(
                        'Camera',
  ...
  //this ths submit form singnup  page ke liye methode
  void _submitFormOnSignUp() async{
    final isValid = _signUpFormKey.currentState!.validate();
    if(isValid){
      if(imagefile == null ){
        GlobalMethod.showErrorDialog(
            error: "Please pick up an image",
            ctx: context,
        );
        return;
      }
        ...
        try{
          ...
          FirebaseFirestore.instance.collection("users").doc(_uid).set({
            ...
            'location': _locationtController.text,
                    ...
                    key: _signUpFormKey,
                      child: Column(
                        children: [
                          ...
                          //this field is address
                          const SizedBox(height: 20,),
                          TextFormField(
                            textInputAction: TextInputAction.next,
                            onEditingComplete: () => FocusScope.of(context).requestFocus(_positionCPFocusNode),
                            keyboardType: TextInputType.text,
                            controller:_locationtController ,
                            validator: (value){
                              if(value!.isEmpty ){
                                return "This Field is missing";
                              }
                          ...
                          //signup cicularprogresss indicater button
                          ...
                          :
                              MaterialButton(onPressed: (){
                                //this ths submit formsingn up ke liye methode
                                _submitFormOnSignUp();
                              },
                                color: Colors.cyan,
                                elevation: 8,
